...
#Script using for read data from sensor SHT35 connected to XBEE 3
#Prepared as part of a diploma thesis: "ZigBee standard in IoT end device communication"
#Script use library: https://github.com/dvsu/Sensirion-SHT3X-MicroPython/tree/main
#----------------------------------------------------------------
import sys
...
print(" +--------------------------------------------+")
print(" | XBee MicroPython I2C SHT35 |")
print(" +--------------------------------------------+\n")

# Instantiate an I2C peripheral.
i2c = I2C(1)

if SHT35_ADDR not in i2c.scan():
